...
1. Atualize seu repositório local no branch `master` mais recente. Talvez seu
   bug já tenha sido corrigido na última versão;
...
Avaliações > Diário de avalições conceituais > Novo lançamento

**DESCRIÇÃO:**

No cadastro de avaliações conceituais, ao tentar selecionar o aluno, o sistema apresenta uma mensagem
informando que não existem resultados encontrados.


**OBSERVAÇÕES:**

Existem alunos cadastrados na turma e a mesma utiliza avaliações conceituais.
